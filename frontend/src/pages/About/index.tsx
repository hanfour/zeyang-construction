...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <section id="homeDreams" className="py-16 md:py-24 bg-white">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-7 gap-8 lg:gap-12">
            ...
            <div className="order-1 lg:order-1 lg:col-span-2 flex flex-col justify-center lg:justify-end">
              <div className="flex justify-center lg:justify-end">
                <div className="flex flex-col items-center lg:items-start" data-aos-anchor="#homeDreams" data-aos="fade-right" data-aos-delay="100">
                  <SectionHeader 
            ...
            {/* Middle Column - Image */}
            <div className="order-2 lg:order-2 lg:col-span-3 flex items-center overflow-hidden" data-aos-anchor="#homeDreams" data-aos="zoom-in" data-aos-delay="200">
              <img 
            ...
            <div className="order-3 lg:order-3 lg:col-span-2 flex flex-col justify-center lg:justify-start" data-aos-anchor="#homeDreams" data-aos="fade-left" data-aos-delay="300">
      ...
      {/* PRESIDENT Section */}
      <section id="president" className="py-16 md:py-24 bg-white">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center lg:items-end">
            ...
            <div className="order-3 lg:order-1 w-full flex flex-col justify-end flex-1 lg:translate-y-24">
              <div className="space-y-6 flex flex-row lg:flex-col">
                ...
                <div className="order-last lg:order-first flex-1 flex justify-center space-x-4 text-black leading-relaxed text-content-mobile lg:text-content-desktop lg:translate-y-16 z-20" data-aos-anchor="#president" data-aos="fade-up" data-aos-delay="200">
                ...
                {/* Bottom Image */}
                <div data-aos-anchor="#president" data-aos="fade-up" data-aos-delay="400">
                  <img 
            ...
            <div className="order-1 lg:order-2 flex flex-col justify-center flex-shrink-0" data-aos-anchor="#president" data-aos="fade-up" data-aos-delay="100">
            ...
            <div className="order-2 lg:order-3 flex flex-col justify-start flex-1 lg:-translate-y-24" data-aos-anchor="#president" data-aos="fade-left" data-aos-delay="300">
              <img 
      ...
      <section id="premium" className="relative py-16 md:py-24 lg:py-0 bg-white">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="flex flex-col lg:block space-y-8 lg:space-y-0">
            ...
            <div className="lg:flex lg:justify-end lg:mb-4">
              <div className="lg:translate-y-20 lg:z-10 lg:relative lg:p-8" data-aos-anchor="#premium" data-aos="fade-left" data-aos-delay="100">
                <SectionHeader 
            ...
            <div className="relative overflow-hidden">
              <img 
                ...
                className="w-full h-auto object-cover"
                data-aos-anchor="#premium"
                data-aos="zoom-in"
                data-aos-delay="200"
              />
              
              {/* Content Text - Mobile below image, Desktop overlay on left */}
              <div className="lg:absolute lg:inset-y-0 lg:flex lg:items-center lg:left-0" data-aos-anchor="#premium" data-aos="fade-right" data-aos-delay="400">
      ...
      <section id="living" className="py-16 md:py-24 bg-white">
        {/* Mobile Layout */}
        <div className="lg:hidden container mx-auto px-6">
          <div className="space-y-12">
            {/* Header */}
            <div data-aos-anchor="#living" data-aos="fade-up" data-aos-delay="100">
              <SectionHeader 
            ...
            <div className="space-y-8">
              {/* Text Content */}
              <div data-aos-anchor="#living" data-aos="fade-up" data-aos-delay="200">
                <ContentText content={aboutSections.living.content} />
              </div>
              
              {/* Images */}
              <div className="space-y-6">
                <div className="w-[85%]" data-aos-anchor="#living" data-aos="fade-right" data-aos-delay="300">
                  <img 
                ...
                <div className='-translate-y-12 w-[85%] ms-[15%]' data-aos-anchor="#living" data-aos="fade-left" data-aos-delay="400">
                  <img 
          ...
          <div className="grid grid-cols-6 gap-0">
            ...
            <div className="col-span-2 pr-8 xl:pr-12 flex flex-col justify-center min-h-[600px]">
              <div className="space-y-8 transform translate-y-8">
                {/* Header */}
                <div data-aos-anchor="#living" data-aos="fade-right" data-aos-delay="1000">
                  <SectionHeader 
                    title={aboutSections.living.title}
                    subtitle={aboutSections.living.subtitle}
                    textAlign="left"
                ...
                {/* Text Content */}
                <div data-aos-anchor="#living" data-aos="fade-right" data-aos-delay="1100">
                  <ContentText content={aboutSections.living.content} />
                </div>
                
                {/* Small Image */}
                <div className="mt-8 overflow-hidden" data-aos-anchor="#living" data-aos="fade-right" data-aos-delay="1200">
                  <img 
                    src={aboutSections.living.smallImage}
                    alt="孩童玩樂"
                    className="w-full h-auto object-cover"
            ...
            <div className="col-span-3 -translate-y-8 overflow-hidden" data-aos-anchor="#living" data-aos="fade-left" data-aos-delay="1300">
              <img 
                src={aboutSections.living.largeImage}
                alt="自然森活環境"
